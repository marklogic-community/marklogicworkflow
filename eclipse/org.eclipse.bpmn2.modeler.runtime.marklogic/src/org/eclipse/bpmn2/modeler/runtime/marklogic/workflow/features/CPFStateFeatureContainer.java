...
public class CPFStateFeatureContainer extends CustomShapeFeatureContainer {

  // these values must match what's in the plugin.xml
  private final static String TYPE_VALUE = "CPFState";
  private final static String CUSTOM_TASK_ID = "CPFState.customTask";

  public CPFStateFeatureContainer() { 
  }
