...
public class CPFFinalFeatureContainer extends CustomShapeFeatureContainer {

  // these values must match what's in the plugin.xml
  private final static String TYPE_VALUE = "CPFFinal";
  private final static String CUSTOM_TASK_ID = "CPFFinal.customTask";

  public CPFFinalFeatureContainer() { 
  }
