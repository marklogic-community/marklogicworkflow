...
public class CPFInitialFeatureContainer extends CustomShapeFeatureContainer {

  // these values must match what's in the plugin.xml
  private final static String TYPE_VALUE = "CPFInitial";
  private final static String CUSTOM_TASK_ID = "CPFInitial.customTask";

  public CPFInitialFeatureContainer() { 
  }
