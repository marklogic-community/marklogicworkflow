...
public class CPFStatusFeatureContainer extends CustomShapeFeatureContainer {

  // these values must match what's in the plugin.xml
  private final static String TYPE_VALUE = "CPFStatus";
  private final static String CUSTOM_TASK_ID = "CPFStatus.customTask";

  public CPFStatusFeatureContainer() { 
  }
