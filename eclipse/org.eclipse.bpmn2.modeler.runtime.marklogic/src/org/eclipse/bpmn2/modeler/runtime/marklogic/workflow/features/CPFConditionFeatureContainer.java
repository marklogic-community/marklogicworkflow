...
public class CPFConditionFeatureContainer extends CustomShapeFeatureContainer {

  // these values must match what's in the plugin.xml
  private final static String TYPE_VALUE = "CPFCondition";
  private final static String CUSTOM_TASK_ID = "CPFCondition.customTask";

  public CPFConditionFeatureContainer() { 
  }
