...
public class CPFActionFeatureContainer extends CustomShapeFeatureContainer {

  // these values must match what's in the plugin.xml
  private final static String TYPE_VALUE = "CPFAction";
  private final static String CUSTOM_TASK_ID = "CPFAction.customTask";

  public CPFActionFeatureContainer() { 
  }
