...
return ( (:
  ...
  test:assert-equal('fork-within-fork__1__0', xs:string($process[2]/createResponse/modelId))
);
...
(: not working with XML ? :)
let $result := wrt:processmodel-publish($const:json-options, "fork-within-fork__1__0")
return ( (:
